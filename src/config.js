...
module.exports = {
  ...
  sections: {
    blog: {
      ...
      paid: false,
      links: [
        { title: 'About me', route: '/blog/about-me' },
        { title: 'Next big step in life', route: '/blog/next-big-step-in-life' },
        { title: 'My professional journey', route: '/blog/my-professional-journey' },
        // { title: 'How I organize my life', route: '/blog/organize' },
        // { title: 'The past decade (2010 - 2020)', route: '/blog/the-past-decade' },
        // { title: 'Indians in Britian', route: '/blog/indians-in-britain' },
        // { title: 'Life in India/Germany/UK', route: '/blog/life-in-de-uk' },
        // { title: 'Moving to Germany', route: '/blog/moving-to-germany' },
      ],
    },
    photos: {
      route: '/photos',
      ...
      links: [
        ...
        { title: 'View from my desk in London', route: '/photos/view-from-my-desk' },
        { title: 'View from the window seat', route: '/photos/view-from-window-seat' },
        { title: 'View of the Shard from the tower', route: '/photos/view-of-the-shard' },
      ],
    },
    // leetcode: {
    //   route: "/leetcode",
