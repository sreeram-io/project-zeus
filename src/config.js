  ...
  sections: {
    story: {
      ...
      links: [
        ...
        { title: 'View from the top of Scotland', route: '/story/top-of-scotland' },
        { title: 'My professional journey', route: '/story/my-professional-journey' },
        { title: 'View from my balcony in India', route: '/story/view-from-my-balcony' },
        { title: 'My studio for rent', route: '/story/studio-for-rent-berlin' },
        { title: 'View from my desk in London', route: '/story/view-from-my-desk' },
        { title: 'The past decade (2010 - 2020)', route: '/story/the-past-decade' },
        { title: 'View from the airplane', route: '/story/view-from-window-seat' },
        { title: 'Life in India/Germany/UK', route: '/story/life-in-de-uk' },
        { title: 'View of the Shard', route: '/story/view-of-the-shard' },
